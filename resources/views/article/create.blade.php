                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('article.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input type="text" name="author" value="{{ old('author') }}" placeholder="Author" id="" class="border-gray-300 shadow-sm w-1/2 rounded-lg text-black">
                                @error('author')
                            ...
                            <div class="my-3">
                                <input type="text" name="title" value="{{ old('title') }}" placeholder="Title" id="" class="border-gray-300 shadow-sm w-1/2 rounded-lg text-black">
                                @error('title')
                                    <span class="text-red-300 font-medium">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="my-3">
                                <textarea name="description" id="" cols="30" rows="10" class="border-gray-300 shadow-sm w-1/2 rounded-lg text-black">{{ old('content') }}</textarea>
                            </div>
